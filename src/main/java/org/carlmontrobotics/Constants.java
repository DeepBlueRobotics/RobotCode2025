...
public final class Constants {
	...
	public static final class OI {
		...
		public static final int y_button = Button.kY.value;
		public static final int b_button = Button.kB.value;
		public static final int a_button = Button.kA.value;
		public static final int x_button = Button.kX.value;
	...
	public static final class AlgaeEffectorc {
		...
		public static final int PINCHER_MOTOR_ID = 31;
