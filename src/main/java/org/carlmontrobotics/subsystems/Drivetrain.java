    ...
    public Drivetrain() {
       ...
       SmartDashboard.putNumber("bigoal", 0);
        ...
        // Initialize modules
        {
            ...
            driveMotors[0] = new SparkMax(Constants.Drivetrainc.driveFrontLeftPort, MotorType.kBrushless), 
            turnMotors[0] = new SparkMax(Constants.Drivetrainc.turnFrontLeftPort, MotorType.kBrushless), 
            ...
            driveMotors[1] = new SparkMax(Constants.Drivetrainc.driveFrontRightPort, MotorType.kBrushless), 
            turnMotors[1] = new SparkMax(Constants.Drivetrainc.turnFrontRightPort, MotorType.kBrushless), 
            ...
            driveMotors[2] = new SparkMax(Constants.Drivetrainc.driveBackLeftPort, MotorType.kBrushless), 
            turnMotors[2] = new SparkMax(Constants.Drivetrainc.turnBackLeftPort, MotorType.kBrushless), 
            ...
            driveMotors[3] = new SparkMax(Constants.Drivetrainc.driveBackRightPort, MotorType.kBrushless), 
            turnMotors[3] = new SparkMax(Constants.Drivetrainc.turnBackRightPort, MotorType.kBrushless), 
