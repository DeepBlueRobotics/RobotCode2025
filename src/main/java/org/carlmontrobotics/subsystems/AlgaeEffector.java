...
public class AlgaeEffector extends SubsystemBase {
    ...
    private final SimpleMotorFeedforward topFeedforward = new SimpleMotorFeedforward(kS[TOP_ARRAY_ORDER],
            kV[TOP_ARRAY_ORDER], kA[TOP_ARRAY_ORDER]);
    private final SimpleMotorFeedforward bottomFeedforward = new SimpleMotorFeedforward(kS[BOTTOM_ARRAY_ORDER],
            kV[BOTTOM_ARRAY_ORDER], kA[BOTTOM_ARRAY_ORDER]);
    private final SimpleMotorFeedforward pincherFeedforward = new SimpleMotorFeedforward(kS[PINCHER_ARRAY_ORDER],
            kV[PINCHER_ARRAY_ORDER], kA[PINCHER_ARRAY_ORDER]);
    private final SimpleMotorFeedforward armFeedforward = new SimpleMotorFeedforward(kS[ARM_ARRAY_ORDER],
            kV[ARM_ARRAY_ORDER], kA[ARM_ARRAY_ORDER]);
    ...
    private double kG;
    // private final ArmFeedforward armFeed = new
    // ArmFeedforward(kS[ARM_ARRAY_ORDER], kG[ARM_ARRAY_ORDER], kV[ARM_ARRAY_ORDER],
    // kA[ARM_ARRAY_ORDER]);
    ...
    public void setArmPosition() {
        ...
        pidControllerArm.setReference(armGoalState.position, ControlType.kPosition, ClosedLoopSlot.kSlot0,
                armFeedVolts);
    ...
    public double getArmPos() {
        ...
        // TODO update the arm to get in degrees after someone will figure out what the
        // .getPosition gets for the TBE
