...
public class DriveRaiseAutonl4Score extends Command {
  ...
  public DriveRaiseAutonl4Score(Drivetrain drivetrain, Elevator elevator, int direction, CoralEffector coralEffector) {
    dir = direction;
