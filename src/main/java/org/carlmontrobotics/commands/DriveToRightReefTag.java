...
public class DriveToRightReefTag extends Command {
  ...
  public DriveToRightReefTag(Drivetrain drivetrain, Limelight limelight){
  ...
  public boolean isFinished() {
      ...
      return (distanceZ*100 < 2 && Math.abs((strafeError-RIGHT_CORAL_BRANCH))*100 < 2);
  }
}
